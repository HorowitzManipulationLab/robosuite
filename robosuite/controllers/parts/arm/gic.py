...
class GeometricImpedanceController(Controller):
    """
    Controller for controlling robot arm via Geometric Impedance Control. Allows position and / or orientation control
